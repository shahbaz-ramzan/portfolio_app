            ...
            {paragraphs.map((paragraph, index) => (
              ...
              >
                ...
                <div className="flex flex-row gap-10 max-lg:flex-col">
                  {/* <div className="w-40 flex flex-col gap-4 items-center justify-between -mt-10 -mb-10 max-lg:flex-row max-lg:m-0">
                  ...
                  <div>
                    <p className="text-white text-4xl w-72 md:w-full">
